...
import AddStoreModal from "../../components/create/AddStoreLocation";
import UpdateStoreModal from "../../components/update/UpdateStoreModal";
        ...
        cell: (info) => (
          <div className="flex space-x-2">
            ...
            <button
              ...
              onClick={() => handleDelete(info.row.original.store_id)}
            >
              Delete
            </button>
          </div>
