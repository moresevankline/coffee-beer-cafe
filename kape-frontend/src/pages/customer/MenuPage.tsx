...
import MealAndDrinkCategories from "../../components/view/MealAndDrinkCategories";
...
const MenuPage = () => {
  ...
  const [groupDrinksCategories, setGroupDrinksCategories] = useState<Category>(
    {}
  );
  ...
  useEffect(() => {
    ...
    const fetchDrinks = async () => {
      try {
        const drink_res = await getProductsWithCategoriesByType("drinks");
