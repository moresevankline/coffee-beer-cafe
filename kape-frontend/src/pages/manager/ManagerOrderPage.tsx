...
import ViewOrderListModal from "../../components/view/ViewOrderListModal";
import { getOrdersManager } from "../../services/manager.service";
import AddOrdersModal from "../../components/create/AddOrdersModal";
        ...
        return (
          <div>
            <button
              ...
              onClick={() => {
                setShowViewOrderListModal(!showViewOrderListModal);
